...
latex_documents = [
    (master_doc, 'Flambe.tex', 'Flambé Documentation',
     'ASAPP Inc.', 'manual'),
]
...
man_pages = [
    (master_doc, 'flambe', 'Flambé Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Flambé', 'Flambé Documentation',
     author, 'Flambé', 'Everyday Flambé, Flambé everyday.',
     'Miscellaneous'),
]
